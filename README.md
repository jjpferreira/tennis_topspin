...
- `KY003_GATE_DISTANCE_CM = 4.5` (centre-to-centre sensor spacing in cm). At this spacing the firmware's 500&nbsp;µs min-transit guard caps measurable speed at ~324&nbsp;km/h, comfortably above any real serve.
